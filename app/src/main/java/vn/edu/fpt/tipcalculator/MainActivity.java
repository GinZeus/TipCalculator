...
public class MainActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        System.out.println("onCreate chay thu: " + danhDauThuTuChay ++);
    ...
    protected void onStart() {
        super.onStart();
        System.out.println("onStart chay thu: " + danhDauThuTuChay ++);
    }

    @Override
    protected void onResume() {
        super.onResume();
        System.out.println("onResume chay thu: " + danhDauThuTuChay ++);
    }

    @Override
    protected void onPause() {
        super.onPause();
        System.out.println("onPause chay thu: " + danhDauThuTuChay ++);
    }

    @Override
    protected void onStop() {
        super.onStop();
        System.out.println("onStop chay thu: " + danhDauThuTuChay ++);
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        System.out.println("onDestroy chay thu: " + danhDauThuTuChay ++);
    }

    @Override
    protected void onRestart() {
        super.onRestart();
        System.out.println("onRestart chay thu: " + danhDauThuTuChay ++);
    }
